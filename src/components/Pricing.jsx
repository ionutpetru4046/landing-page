                ...
                <div key={index} className="w-full sm:h-1/2 lg:w-1/3 p-2">
                    <div className="p-10 border border-neutral-700 rounded-xl">
                        <p className="text-4xl mb-8">
                            {option.title}
                            {option.title === "Pro" && <span className="bg-gradient-to-r from-orange-500 to bg-red-400 text-transparent 
                        ...
                        w-full h-12 p-5 mt-20 tracking-tight text-xl hover:bg-orange-700 
